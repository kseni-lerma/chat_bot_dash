    ...
    function updateDetailView() {
        ...
        // Автоматически перемещаем таблицу
        positionTable();
    }
    
    // Правильное позиционирование таблицы
    function positionTable() {
        // Если есть второй график - таблица после него, иначе после первого
        if (premiumChartContainer.classList.contains('hidden')) {
            detailTableContainer.style.marginTop = '0';
        } else {
            detailTableContainer.style.marginTop = '40px';
        }
    }
